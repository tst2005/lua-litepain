...
--
-- NOTE: everything in this module is also available in `lp.utils`.
-- @module lp.compat
local compat = {}
...
compat.dir_separator = require "lp.detect".dir_separator

-- boolean flag this is a Windows platform.
-- @field is_windows
-- @see lp.detect.is_windows
compat.is_windows = require "lp.detect".is_windows

--]===]------------------------------------------------------------------------

-- @import compat/execute.lua
